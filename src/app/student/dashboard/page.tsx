      ...
      <div className="max-w-7xl mx-auto px-6 mt-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
          ...
          <div className="bg-white border border-slate-200 rounded-xl px-5 py-2.5 flex items-center gap-6 shadow-sm text-xs font-bold">
            <div><span className="text-slate-400 uppercase block mb-0.5">Name</span><span className="text-slate-800 text-sm">Budi</span></div>
            <div className="h-8 w-[1px] bg-slate-200"></div>
            <div><span className="text-slate-400 uppercase block mb-0.5">Student ID</span><span className="text-[#0a192f] text-sm">STUD001</span></div>
          </div>
        </div>
