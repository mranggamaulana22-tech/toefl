...
export default function ExamTopbar({ sectionName, showNavigator, onToggleNavigator, formattedTime }: ExamTopbarProps) {
  return (
    <div className="bg-[#1e293b] text-white h-14 px-6 flex items-center justify-between shadow-md sticky top-0 z-40">
      ...
      <div className="flex items-center gap-4">
        <button 
          ...
          className="text-xs bg-slate-700/80 hover:bg-slate-700 px-3 py-1.5 rounded-lg border border-slate-600 transition-all font-semibold"
        >
